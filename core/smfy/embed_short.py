...
try:
    ...
    banner='Agility Shell'
    exit_msg=''
else:
    banner = '*** Agility Shell 0.1 ***'
...
|  _  |/ _` | | | | __| | | |  `--. \ '_ \ / _ \ | |
| | | | (_| | | | | |_| |_| | /\__/ / | | |  __/ | |
\_| |_/\__, |_|_|_|\__|\__, | \____/|_| |_|\___|_|_|
        __/ |           __/ |                       
       |___/           |___/                        

        ** Type a. and hit TAB to start! **       
'''
    ipshell = InteractiveShellEmbed(banner1=agilitybanner)
