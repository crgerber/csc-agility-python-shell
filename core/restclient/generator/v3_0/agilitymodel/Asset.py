from base.Asset import AssetBase
from actions.Asset import AssetActions
...
class Asset(AssetBase, AssetActions):
    ...
    def __init__(self, assettype=None, usedbyassets=[], importmode=None, uuid=None, detailedassetpath=None, tags=None, assetproperties=[], foreignassetproperties=[], top=False, importdirectives=None, name=None, lifecycleversion=None, assetlist=[], asset=[], removable=None, lifecyclelastcomment=None, assetpath=None, lifecyclestate=None, id=None, applicationtype=None, description=None):
        ...
        '''
        AssetBase.__init__(self, assettype=assettype, usedbyassets=usedbyassets, importmode=importmode, uuid=uuid, detailedassetpath=detailedassetpath, tags=tags, assetproperties=assetproperties, foreignassetproperties=foreignassetproperties, top=top, importdirectives=importdirectives, name=name, lifecycleversion=lifecycleversion, assetlist=assetlist, asset=asset, removable=removable, lifecyclelastcomment=lifecyclelastcomment, assetpath=assetpath, lifecyclestate=lifecyclestate, id=id, applicationtype=applicationtype, description=description)
