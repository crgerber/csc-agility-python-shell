...
class Location(LocationBase, LocationActions):
    ...
    def __init__(self, repositories=[], properties=[], visible=None, parentlocation=None, hosts=[], cloud=None, storageroot=None, networks=[], sublocations=[]):
        ...
        '''
        LocationBase.__init__(self, repositories=repositories, properties=properties, visible=visible, parentlocation=parentlocation, hosts=hosts, cloud=cloud, storageroot=storageroot, networks=networks, sublocations=sublocations)
