...
class TopologyStatsBase(AgilityModelBase):
    ...
    def __init__(self, numstarting=None, numserviceinstances=None, maxcount=None, numinstances=None, numdestroyed=None, numstopped=None, topologyid=None, numstopping=None, numfailed=None, numrunning=None, status='', numunknown=None, numtemplates=None, numdegraded=None, mincount=None, numpaused=None):
        ...
        self._attrSpecs.update({'numServiceInstances': {'type': 'int', 'name': 'numserviceinstances', 'native': True}, 'status': {'type': 'string', 'name': 'status', 'native': True}, 'numDegraded': {'type': 'int', 'name': 'numdegraded', 'native': True}, 'numInstances': {'type': 'int', 'name': 'numinstances', 'native': True}, 'numDestroyed': {'type': 'int', 'name': 'numdestroyed', 'native': True}, 'numStopped': {'type': 'int', 'name': 'numstopped', 'native': True}, 'topologyId': {'type': 'int', 'name': 'topologyid', 'native': True}, 'numStopping': {'type': 'int', 'name': 'numstopping', 'native': True}, 'numPaused': {'type': 'int', 'name': 'numpaused', 'native': True}, 'numFailed': {'type': 'int', 'name': 'numfailed', 'native': True}, 'numStarting': {'type': 'int', 'name': 'numstarting', 'native': True}, 'numUnknown': {'type': 'int', 'name': 'numunknown', 'native': True}, 'numTemplates': {'type': 'int', 'name': 'numtemplates', 'native': True}, 'maxCount': {'type': 'int', 'name': 'maxcount', 'native': True}, 'minCount': {'type': 'int', 'name': 'mincount', 'native': True}, 'numRunning': {'type': 'int', 'name': 'numrunning', 'native': True}})
