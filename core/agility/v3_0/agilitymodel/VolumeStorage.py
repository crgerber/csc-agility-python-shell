...
class VolumeStorage(VolumeStorageBase, VolumeStorageActions):
    ...
    classdocs
    '''
    def __init__(self, hasfilesystem=None, volumesnapshots=[], storage=[], location=None, volume=None, instance=None, unit=None, storageid=None, device=None, snapshotid=None, cloud=None, size=None):
        '''
        Constructor
