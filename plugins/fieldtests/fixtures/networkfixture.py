...
class NetworkFixture(BaseFixture):
    '''
    includes setup and tear down for script creation, plus helper methods
    '''
    
    def __init__(self, conn=None, assetName='Network', snapshot=BaseFixture.SNAPSHOT.NEW):
    ...
    def _selectCompareAttrs(self, detailedAssetList):
        return ['networkId', 'name', 'description', 'networkAddress', 'networkGateway', 'networkMask']
