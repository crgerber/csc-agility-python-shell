...
class TransportTest (unittest.TestCase):
    ...
    def test_2_compute_key(self):
        ...
        self.assertEqual('207E66594CA87C44ECCBA3B3CD39FDDB378E6FDB0F97C54B2AA0CFBF900CD995',
                          hexlify(key).upper())
    ...
    def test_D_x11(self):
        ...
        self.assertEqual('hello', x11_client.recv(5))
    ...
    def test_E_reverse_port_forwarding(self):
        ...
        sch.send('hello')
        self.assertEqual('hello', cch.recv(5))
        sch.close()
        cch.close()
        ss.close()
        cs.close()
